...
- Shows **current playback time** relative to total video duration.
- Allows scrubbing to seek a new playback position.
- Automatically updates as playback progresses.
- Fully themed: colors come from the video player's `theme`.
- Expands visibility of controls when sliding begins.
