---
sidebar_label: VideoProvider
sidebar_position: 1
---

# VideoProvider

The `VideoProvider` is a component that manages the state of the video player and makes it available to all its children. It uses a reducer to handle state changes and provides the video state to all its children.
...
| `controlsOpacity` | `SharedValue<number>  `                                     | `null`                                    | The opacity of the controls.           |
...
| `SET_CONTROLS_OPACITY` | `SharedValue<number>`                                             | Sets the opacity of the controls.                 |                                         |
