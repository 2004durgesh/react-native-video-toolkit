---
title: Common
description: Common utility functions for combining event handlers and other helper utilities.
---
...
<Callout type="info">
  You can use `combineHandlers` to merge your custom `onPress` handler with the one provided by a component. This is
