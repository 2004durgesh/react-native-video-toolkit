...
| `setVideoTrack`           | `(newVideoTrack: VideoTrack \| null) => void` | A function to set the current video quality.                         |
| `setAvailableVideoTracks` | `(videoTracks: VideoTrack[]) => void`         | A function to set the list of available video qualities.             |
