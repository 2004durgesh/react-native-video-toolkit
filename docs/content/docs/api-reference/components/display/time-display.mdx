...
import { TimeDisplayExample } from '@/components/examples/display/time-display';

## Usage

<CodePreviewTabs preview={<TimeDisplayExample />}>

```json doc-gen:file
{
  "file": "./src/components/examples/display/time-display.tsx",
  "codeblock": {
    "lang": "tsx"
  }
}
