...
| `titleProps`    | `Omit<TitleProps, 'text'>`    |         | Props to pass to the underlying `Title` component (e.g., for styling).     |
| `subtitle`      | `string`                      |         | A subtitle or secondary text, displayed below the main title.              |
| `subtitleProps` | `Omit<SubtitleProps, 'text'>` |         | Props to pass to the underlying `Subtitle` component (e.g., for styling).  |
